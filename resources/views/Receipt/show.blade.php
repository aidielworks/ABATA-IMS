...
<div class="card">
    <div class="card-header">
        <h4 class="d-inline">Receipt Details: {{$receipt->receipt_no}}</h4> <a href="{{$receipt->id}}/edit" class="btn btn-primary d-inline float-right"><i class="fas fa-edit mr-2"></i>Edit</a>
    </div>
    <div class="card-body">
